...
| EP08 | INR-based 2x contour SR | ✅ Stage 2 四方对比完成；结果表 `output/ep08_inr_sr/stage2_comparison.csv` | `ep08_inr_sr/` |
| EP09 | PSF Sigma 精确标定 | ✅ 首轮完成；三路线不一致，4x 门控未清除 | `ep09_psf_calibration/` |
