# %% [markdown]
# ## S-F14 — MAP-TV 去卷积锚的结构证据（supp D.2.3 配图）
#
# 「FWHM 114→100 µm 有限轮廓增强」主张的视觉来源：三条 zigzag 剖面的
# bare drizzle vs MAP-TV 对照，以及四臂 highpass 全景。
...
display(Markdown("**figS14b — 四臂 highpass 对照（bicubic / drizzle / MAP-TV / EP07-v6 ×2.5up）**"))
