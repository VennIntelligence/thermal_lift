...
#
# 四个 1x 变体全部 checkpoint 在 (artifact, corr) 平面上的散点 + TGV 参考点 +
...
# %% [markdown]
# > **图表说明**: TB-scale proxy 平面，每点一个 checkpoint，颜色区分变体；
# > 星标为 TGV 参考点 (0.695, 0.916)；圆圈标注 canonical 选点
# > （v6@8K、v8.1a@15K、v8.1b@5K、v9b@11K）。
# > **怎么看**: 左上方向（低 artifact、高 corr）更好；各变体 60K 端点全部位于
# > 右下——**按端点上报会让每个变体交出最差 checkpoint**（§6.6 金句的数据来源）。
