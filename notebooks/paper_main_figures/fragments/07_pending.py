...
# | 图表 | 内容 | 阻塞依赖 | 预期生产路径 |
# |---|---|---|---|
# | F0 teaser | bicubic / TGV / 最优学习臂 中心 zigzag 三列 | F5 终稿 + 客户许可 | F5 裁剪 |
# | F5 主视觉对比 | 温度域 + highpass 域 × 6 列 + 消融行 | ① V9A/V9C/V10 选点 ② 统一口径 harness ③ ROI 冻结 ④ 客户许可 | `run_unet_vs_drizzle_2x.py` 谱系 |
